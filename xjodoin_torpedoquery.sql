...
select entity_0 from Entity entity_0 inner join Entity2 entity2_1 on entity2_1.code = entity_0.code and entity2_1.var = :var_2
select entity_0 from Entity entity_0 where entity_0.code <> :code_1
...
select entity_0 from Entity entity_0 inner join Entity2 entity2_1 on entity2_1.code = entity_0.code
...
select entity_0 from Entity entity_0 right join Entity2 entity2_1 on entity2_1.code = entity_0.code
...
select entity_0 from Entity entity_0 right join Entity2 entity2_1 on entity2_1.code = entity_0.code where entity2_1.code = :code_2
...
select entity_0 from Entity entity_0 where lower(entity_0.code) not like '%test%'
...
select entity_0 from Entity entity_0 inner join Entity2 entity2_1 on entity2_1.code = entity_0.code where entity2_1.code = :code_2
...
select entity_0 from Entity entity_0 left join Entity2 entity2_1 on entity2_1.code = entity_0.code
select entity_0 from Entity entity_0 where entity_0.code not like '%test%'
...
select entity_0 from Entity entity_0 where entity_0.code not like '%test'
select entity_0 from Entity entity_0 inner join entity_0.subEntities subEntity_1 order by subEntity_1.code,entity_0.name
...
select entity_0 from Entity entity_0 left join Entity2 entity2_1 on entity2_1.code = entity_0.code where entity2_1.code = :code_2
select entity_0 from Entity entity_0 where ( lower(entity_0.code) like '%test%' )
select entity_0 from Entity entity_0 where entity_0.integerField <= :integerField_1
