...
select * from v_report_payment_provider_errors_sub2;
...
select * from v_report_mrr_daily;
...
select * from v_report_refunds_total_daily;
...
select * from v_report_invoices_balance_daily;
...
select * from v_report_payments_total_daily limit 0;
select * from v_report_accounts_summary;
...
select * from v_report_new_accounts_daily;
select * from v_report_active_by_product_term_monthly;
...
select * from v_report_accounts_summary limit 0;
...
select * from v_report_payment_provider_errors limit 0;
...
select * from v_report_invoices_daily limit 0;
...
select * from v_report_mrr_daily limit 0;
select * from v_report_payment_provider_errors_sub2 limit 0;
...
select * from v_report_payments_by_provider_last_24h_summary limit 0;
...
select * from v_report_invoices_daily;
...
select * from v_report_payments_by_provider_last_24h_summary;
select * from v_report_invoices_balance_daily limit 0;
...
select * from v_report_new_accounts_daily limit 0;
...
select * from v_report_cancellations_daily;
...
select * from v_report_payments_total_daily;
...
select * from v_report_refunds_total_daily limit 0;
...
select * from v_report_chargebacks_daily limit 0;
create table analytics_payment_method_fields ( record_id serial unique, custom_field_record_id bigint /*! unsigned */ default null, payment_method_id varchar(36) default null, name varchar(64) default null, value varchar(255) default null, created_date datetime default null, created_by varchar(50) default null, created_reason_code varchar(255) default null, created_comments varchar(255) default null, account_id varchar(36) default null, account_name varchar(100) default null, account_external_key varchar(255) default null, account_record_id bigint /*! unsigned */ default null, tenant_record_id bigint /*! unsigned */ default null, report_group varchar(50) not null, primary key(record_id))
...
create table analytics_transaction_fields ( record_id serial unique, custom_field_record_id bigint /*! unsigned */ default null, transaction_id varchar(36) default null, name varchar(64) default null, value varchar(255) default null, created_date datetime default null, created_by varchar(50) default null, created_reason_code varchar(255) default null, created_comments varchar(255) default null, account_id varchar(36) default null, account_name varchar(100) default null, account_external_key varchar(50) default null, account_record_id bigint /*! unsigned */ default null, tenant_record_id bigint /*! unsigned */ default null, report_group varchar(50) not null, primary key(record_id))
select * from v_report_chargebacks_daily;
...
select * from v_report_cancellations_daily limit 0;
...
select * from v_report_active_by_product_term_monthly limit 0;
...
create table analytics_bundle_fields ( record_id serial unique, custom_field_record_id bigint /*! unsigned */ default null, bundle_id varchar(36) default null, bundle_external_key varchar(255) default null, name varchar(64) default null, value varchar(255) default null, created_date datetime default null, created_by varchar(50) default null, created_reason_code varchar(255) default null, created_comments varchar(255) default null, account_id varchar(36) default null, account_name varchar(100) default null, account_external_key varchar(255) default null, account_record_id bigint /*! unsigned */ default null, tenant_record_id bigint /*! unsigned */ default null, report_group varchar(50) not null, primary key(record_id))
