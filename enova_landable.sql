...
CREATE TABLE referers ( referer_id integer NOT NULL, domain_id integer NOT NULL, path_id integer, query_string_id integer NOT NULL, attribution_id integer NOT NULL)
