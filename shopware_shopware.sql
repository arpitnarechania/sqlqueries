...
SELECT allow_shipping FROM s_core_countries WHERE id = ?', [$id]);
...
UPDATE s_core_countries SET allow_shipping = 0  WHERE id = 25
...
UPDATE s_core_auth SET lockedUntil = NOW WHERE id = ?
